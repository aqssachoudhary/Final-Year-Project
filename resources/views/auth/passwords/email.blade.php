...
<body class="account-page">
        ...
        <div class="account-content">
            <div class="container">
                ...
                <div class="account-logo">
                    <a href="{{ url('login') }}"><img src="{{ asset('assets/img/logo2.png') }}"
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        @csrf
                            ...
                            <div class="input-block mb-4 text-center">
                                <button class="btn btn-primary account-btn" type="submit" name="">Send Password Reset Link</button>
                            </div>
    ...
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js')}}"
        data-cf-settings="7afad0dda06c6cf56708a98b-|49" defer></script>
</body>
