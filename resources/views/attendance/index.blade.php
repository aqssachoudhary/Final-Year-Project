      ...
      <div class="col-lg-12 card-4">
        <div class="table-responsive">
          <table class="table table-striped custom-table mb-0">
            ...
            <tbody> @foreach($attendencs as $attendance) <tr>
...
</div>undefined</div>undefined<div class="settings-icon">undefined<span data-bs-toggle="offcanvas" data-bs-target="#theme-settings-offcanvas" aria-controls="theme-settings-offcanvas">
    <i class="las la-cog"></i>undefined</span>undefined</div>undefined<div class="settings-icon">undefined<span data-bs-toggle="offcanvas" data-bs-target="#theme-settings-offcanvas" aria-controls="theme-settings-offcanvas">
    <i class="las la-cog"></i>undefined</span>undefined</div>undefined<div class="offcanvas offcanvas-end border-0 " tabindex="-1" id="theme-settings-offcanvas">undefined<div class="sidebar-headerset">
