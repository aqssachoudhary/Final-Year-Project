    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body card p-4">
          <form method="post" action="{{url('department')}}"> @csrf <div class="row">
              <div class="col-sm-4">
      ...
      <div class="settings-mains">
        ...
        <div id="sidebar-view">
          ...
          <div class="row">
            <div class="col-4">
              <div class="form-check sidebar-setting card-radio  p-0">
                <input class="form-check-input" type="radio" name="data-layout-style" id="sidebar-view-default" value="default">undefined<label class="form-check-label avatar-md w-100" for="sidebar-view-default">undefined<img src="assets/img/compact.png" alt="Layout Image">undefined</label>undefined
              </div>undefined<h5 class="fs-13 text-center mt-2">Default</h5>
            </div>
