    ...
    <div class="page-header">
      <div class="row align-items-center">
        ...
        <div class="col-auto float-end ms-auto">
          <a href="{{url('teacher/create')}}" class="btn add-btn">
            <i class="fa-solid fa-plus"></i> Add teacher </a>
        </div>
      ...
      </div> @foreach ($teachers as $teacher) <div class="row staff-grid-row">
        <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
          <div class="profile-widget">
            ...
            <h4 class="user-name m-t-10 mb-0 text-ellipsis">
              <a href="profile.html">{{$teacher->first_name}}</a>
            </h4>
            <div class="small text-muted">{{$teacher->department}}</div>
          </div>
        </div>
      </div> @endforeach <div id="add_employee" class="modal custom-modal fade" role="dialog">
