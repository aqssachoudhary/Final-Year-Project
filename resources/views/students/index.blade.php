@extends('layouts.app') @section('content') <div class="page-wrapper">
  <div class="content container-fluid pb-0">
    <div class="page-header">
      <div class="row align-items-center">
        ...
        <div class="col-auto float-end ms-auto">
          <a href="{{url('student/create')}}" class="btn add-btn">
            <i class="fa-solid fa-plus"></i> Add Students </a>
        </div>
      </div>
    </div> @foreach ($students as $student) <div class="row staff-grid-row ">
      <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3 d-flex">
        <div class="profile-widget w-100">
          ...
          <h4 class="user-name m-t-10 mb-0 text-ellipsis">
            <a href="client-profile.html">{{$student->first_name}}</a>
          </h4>
          <h5 class="user-name m-t-10 mb-0 text-ellipsis">
            <a href="client-profile.html">{{$student->last_name}}</a>
          </h5>
    ...
    </div> @endforeach <div id="add_client" class="modal custom-modal fade" role="dialog">
                ...
                <table class="table table-striped custom-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <label class="custom_check">undefined<input type="checkbox" checked>undefined<span class="checkmark"></span>undefined</label>
                      </td>
                      <td class="text-center">undefined<label class="custom_check">undefined<input type="checkbox" checked>undefined<span class="checkmark"></span>undefined</label>undefined</td>undefined<td class="text-center">undefined<label class="custom_check">undefined<input type="checkbox" checked>undefined<span class="checkmark"></span>undefined</label>undefined</td>undefined
                    </tr>
                  </tbody>
                </table>
              </div>
